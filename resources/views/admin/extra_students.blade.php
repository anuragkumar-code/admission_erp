                                        ...
                                        <tbody>
                                            <?php if($get_extra_students ){ 
                                                ...
                                                <tr class="migration_row<?php echo $get_extra_student->id; ?>">
                                                    ...
                                                    <td><a style="color: blue" href="{{url('admin/student-details/'.base64_encode($get_extra_student->id))}}">{{$get_extra_student->first_name}} {{$get_extra_student->middle_name}} {{$get_extra_student->last_name}}
                                                    ...
                                                    <div class="dropdown dropbtn">                                                       
                                                          ...
                                                          <div class="dropdown-menu dropmenu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <a class="dropdown-item" href="{{url('extra_student_detail/'.base64_encode($get_extra_student->id))}}">Details</a>
                                                            <a class="dropdown-item" href="{{url('admin/student-deleted/'.base64_encode($get_extra_student->id))}}" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                                                          </div>
                                                    </div>
                                                    </td>
                                                </tr>
