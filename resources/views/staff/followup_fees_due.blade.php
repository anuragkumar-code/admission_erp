                                             ...
                                             <tbody>
                                                ...
                                                if($fees_duedate_students_count > 0){ 
                                                   ...
                                                   foreach ($fees_duedate_students as $key => $fees_duedate_students_val) {
                                                      ...
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('staff/student-details/'.$student_id)}}">{{$fees_duedate_students_val->first_name}}</a></td>
                                        ...
                                        <tbody>
                                                ...
                                                if($snooze_fees_duedate_students){ 
                                                   ...
                                                   foreach ($snooze_fees_duedate_students as $key => $snooze_fees_duedate_students_val) {
                                                      ...
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('staff/student-details/'.$student_id)}}">{{$snooze_fees_duedate_students_val->first_name}}</a></td>
                                        ...
                                        <tbody>
                                                ...
                                                if($close_fees_duedate_students){ 
                                                   ...
                                                   foreach ($close_fees_duedate_students as $key => $close_fees_duedate_students_val) {
                                                      ...
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('staff/student-details/'.$student_id)}}">{{$close_fees_duedate_students_val->first_name}}</a></td>
