...
(function(factory) {
    ...
    return function() {
        ...
        var defaults = {
            ...
            preferredCountries: [ "in", "us", "gb", "de", "jp", "bd", "pk" ],
            ...
            _createClass(Iti, [ {
                ...
                value: function _generateMarkup() {
                    ...
                    this.selectedFlagInner = this._createEl("div", {
                        "class": "iti__flag thereismeta-phone"
                    }, this.selectedFlag);
                    if (this.options.separateDialCode) {
                        this.selectedDialCode = this._createEl("div", {
                            "class": "iti__selected-dial-code-phone"
                        }, this.selectedFlag);
                    }
                ...
                value: function _appendListItems(countries, className) {
                    ...
                    for (var i = 0; i < countries.length; i++) {
                        ...
                        // add the flag
                        tmp += "<div class='iti__flag-box'><div class='iti__flag demoflat iti__".concat(c.iso2, "'></div></div>");
                ...
                value: function _setFlag(countryCode) {
                    ...
                    this.selectedFlagInner.setAttribute("class", "iti__flag data1 iti__".concat(countryCode));
