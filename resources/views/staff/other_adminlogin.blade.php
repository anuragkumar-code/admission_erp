                ...
                <div class="col-lg-5">
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                             ...
                             <span class="headtxt"><h2>Admin Login</h2></span>
                            ...
                            <form action="{{route('other_adminlogin')}}" method="post">
                            ...
                            <li>  If You are  Super Admin  <strong>  <a href="{{route('login')}}" >Click Here  </a> </strong> to Sign in</li> 
...
<script>
 ...
 Swal.fire({
  title: 'Welcome!',
  text: "This is testing Purpose admin panel If are not a Developer then please click to continue button!",
  icon: 'warning',
  ...
  if (result.isConfirmed) {
    window.location.href = 'http://royalmigration.com.au/rms/public/other_admin/login';
  }
})
