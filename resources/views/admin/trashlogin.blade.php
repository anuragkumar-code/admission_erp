                ...
                <div class="col-lg-5">
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                             ...
                             <span class="headtxt"><h5>Please login with unique password to access Trash Details. </h5></span>
                            ...
                            <form action="{{route('trashloggedin')}}" method="post">
                                ...
                                <p><a href="{{route('trash_change_password')}}">Change Password?</a></p>                                
