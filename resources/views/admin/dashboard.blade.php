                ...
                <div class="col-md-3">                    
                    <div class="dash_box1">
                        ...
                        <div class="dash_details">
                            <ul>
                                <li><a href="{{url('fees_due#feesdue-open-tab')}}">Open requests ({{$fees_duedate_students_count}})</a></li>
                                <li><a href="{{url('fees_due#feesdue-snooze-tab')}}">Snooze requests ({{$snooze_fees_duedate_students_count}})</a></li>
                                <li><a href="{{url('fees_due#feesdue-close-tab')}}">Close requests ({{$close_fees_duedate_students_count}})</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
