                ...
                <div class="headertopcontent">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fees_open active" id="feesdue-open-tab" data-toggle="pill" data-target="#feesdue-open" type="button" role="tab" aria-controls="feesdue-open-tab" aria-selected="true">Open</button>
                        </li>
                         <li class="nav-item" role="presentation">
                            <button class="nav-link fees_snooze" id="feesdue-snooze-tab" data-toggle="pill" data-target="#feesdue-snooze" type="button" role="tab" aria-controls="feesdue-snooze" aria-selected="false">Snooze</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fees_close" id="feesdue-close-tab" data-toggle="pill" data-target="#feesdue-close" type="button" role="tab" aria-controls="feesdue-close" aria-selected="false">Close</button>
                        </li>
                            ...
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive studenttabless">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                       <div class="tab-pane fade show active feesdue_open" id="feesdue-open" role="tabpanel" aria-labelledby="feesdue-open-tab">

                                          <table class="table table-striped table-bordered" id="open_feesdue">
                                             ...
                                             <tbody>
                                                ...
                                                if($fees_duedate_students_count > 0){ 
                                                   ...
                                                   foreach ($fees_duedate_students as $key => $fees_duedate_students_val) {
                                                      ...
                                                      $student_id = base64_encode($fees_duedate_students_val->stid);
                                                      ?>                                           
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('admin/student-details/'.$student_id)}}">{{$fees_duedate_students_val->first_name}}</a></td>
                                                         <td>{{$fees_duedate_students_val->staff_name}}</td>
                                                         <td>{{$fees_duedate_students_val->email}}</td>
                                                         <td>{{$fees_duedate_students_val->phone}}</td>
                                                          <td><?php echo date('d-m-Y',strtotime($fees_duedate_students_val->fee_due_date)); ?></td>
                                                         <td>
                                                            <?php

                                                            if(isset($fees_duedate_students_val->fees_due_snooze_date) && $fees_duedate_students_val->fees_due_snooze_date != '')

                                                            {
                                                               $fee_due_date = strtotime($fees_duedate_students_val->fees_due_snooze_date);
                                                               echo date('d-m-Y',strtotime($fees_duedate_students_val->fees_due_snooze_date));
                                                            }
                                                            else
                                                            {   
                                                               $fee_due_date = strtotime($fees_duedate_students_val->fee_due_date);
                                                               echo date('d-m-Y',strtotime($fees_duedate_students_val->fee_due_date));
                                                            }
                                                            ?>
                                                         </td>
                                                         <td>
                                                            <?php
                                                            if(isset($fees_duedate_students_val->fee_due_date) && $fees_duedate_students_val->fee_due_date != '')
                                                            {
                                                               $fee_due_date = strtotime($fees_duedate_students_val->fee_due_date);

                                                               if($curr_date > $fee_due_date)
                                                               {
                                                                  ?>
                                                         ...
                                                         <td style="width: 170px;float: right;">
                                                            ...
                                                            <a href="javascript:void(0);" data-id="{{$fees_duedate_students_val->id}}" data-name="{{$fees_duedate_students_val->first_name}}" data-phone="{{$fees_duedate_students_val->phone}}"  data-dialcode="{{$fees_duedate_students_val->phone_dialcode}}"  data-flag="{{$fees_duedate_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_sms"><i style='font-size:22px !important' class="fa fa-comment-o"></i></a>    


                                                        <a href="javascript:void(0);" data-id="{{$fees_duedate_students_val->id}}" data-name="{{$fees_duedate_students_val->first_name}}" data-phone="{{$fees_duedate_students_val->phone}}"  data-dialcode="{{$fees_duedate_students_val->phone_dialcode}}"  data-flag="{{$fees_duedate_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_whatsapp"><i style='font-size:22px !important'  class="fa fa-whatsapp" aria-hidden="true"></i></a> 


                                                        <a href="javascript:void(0);" data-id="{{$fees_duedate_students_val->id}}" data-name="{{$fees_duedate_students_val->first_name}}" data-phone="{{$fees_duedate_students_val->phone}}" data-email="{{$fees_duedate_students_val->email}}"  data-dialcode="{{$fees_duedate_students_val->phone_dialcode}}"  data-flag="{{$fees_duedate_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_mail"><i style='font-size:22px !important'  class="fa fa-envelope-o" aria-hidden="true"></i></a> 

                                                            <button type="button" class="btn btn-primary visa_status" data-toggle="modal" data-target="#open_visa" data-userid="{{$fees_duedate_students_val->stid}}" data-username="{{$fees_duedate_students_val->first_name}}" data-cfd_id="{{$fees_duedate_students_val->cfd_id}}">View</button></td>
                                                         </tr>
                                                         <?php $count++; }  }?>
                                                      </tbody>
                                                   </table>                                           
...
<div class="tab-pane fade feesdue_snooze" id="feesdue-snooze" role="tabpanel" aria-labelledby="feesdue-snooze">  
        ...
        <table class="table table-striped table-bordered" id="snooze_passport_expire">
                                        ...
                                        <tbody>
                                                <?php
                                                $curr_date =  strtotime(date('d-m-Y'));
                                                if($snooze_fees_duedate_students){ 
                                                   $count = 1;
                                                   foreach ($snooze_fees_duedate_students as $key => $snooze_fees_duedate_students_val) {

                                                      $student_id = base64_encode($snooze_fees_duedate_students_val->stid);
                                                      ?>                                           
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('admin/student-details/'.$student_id)}}">{{$snooze_fees_duedate_students_val->first_name}}</a></td>
                                                         <td>{{$snooze_fees_duedate_students_val->staff_name}}</td>
                                                         <td>{{$snooze_fees_duedate_students_val->email}}</td>
                                                         <td>{{$snooze_fees_duedate_students_val->phone}}</td>
                                                        <td><?php echo date('d-m-Y',strtotime($snooze_fees_duedate_students_val->fee_due_date)); ?></td>
                                                         <td>
                                                            <?php
                                                            if(isset($snooze_fees_duedate_students_val->fees_due_snooze_date) && $snooze_fees_duedate_students_val->fees_due_snooze_date != '')
                                                            {
                                                               $fee_due_date = strtotime($snooze_fees_duedate_students_val->fees_due_snooze_date);
                                                               echo $snooze_fees_duedate_students_val->fees_due_snooze_date;
                                                            }
                                                            else
                                                            {   
                                                               $fee_due_date = strtotime($snooze_fees_duedate_students_val->fee_due_date);
                                                               echo $snooze_fees_duedate_students_val->fee_due_date;
                                                            }
                                                            ?>
                                                         </td>
                                                         ...
                                                         <td style="width: 170px;float: right;">
                                                            ...
                                                            <a href="javascript:void(0);" data-id="{{$snooze_fees_duedate_students_val->id}}" data-name="{{$snooze_fees_duedate_students_val->first_name}}" data-phone="{{$snooze_fees_duedate_students_val->phone}}"  data-dialcode="{{$snooze_fees_duedate_students_val->phone_dialcode}}"  data-flag="{{$snooze_fees_duedate_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_sms"><i style='font-size:22px !important' class="fa fa-comment-o"></i></a>    


                                                        <a href="javascript:void(0);" data-id="{{$snooze_fees_duedate_students_val->id}}" data-name="{{$snooze_fees_duedate_students_val->first_name}}" data-phone="{{$snooze_fees_duedate_students_val->phone}}"  data-dialcode="{{$snooze_fees_duedate_students_val->phone_dialcode}}"  data-flag="{{$snooze_fees_duedate_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_whatsapp"><i style='font-size:22px !important'  class="fa fa-whatsapp" aria-hidden="true"></i></a> 


                                                        <a href="javascript:void(0);" data-id="{{$snooze_fees_duedate_students_val->id}}" data-name="{{$snooze_fees_duedate_students_val->first_name}}" data-phone="{{$snooze_fees_duedate_students_val->phone}}" data-email="{{$snooze_fees_duedate_students_val->email}}"  data-dialcode="{{$snooze_fees_duedate_students_val->phone_dialcode}}"  data-flag="{{$snooze_fees_duedate_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_mail"><i style='font-size:22px !important'  class="fa fa-envelope-o" aria-hidden="true"></i></a> 

                                                            <button type="button" class="btn btn-primary visa_status" data-toggle="modal" data-target="#open_visa" data-userid="{{$snooze_fees_duedate_students_val->stid}}"  data-username="{{$snooze_fees_duedate_students_val->first_name}}" data-cfd_id="{{$snooze_fees_duedate_students_val->cfd_id}}">View</button></td>
                                                         </tr>
                                                         <?php $count++; }  }?>
                                                      </tbody>
                                    </table> 
        ...
        <div class="tab-pane fade feesdue_close" id="feesdue-close" role="tabpanel" aria-labelledby="feesdue-close"> 
        ...
        <table class="table table-striped table-bordered" id="close_passport_expire">
                                        ...
                                        <tbody>
                                                <?php
                                                $curr_date =  strtotime(date('d-m-Y'));
                                                if($close_fees_duedate_students){ 
                                                   $count = 1;
                                                   foreach ($close_fees_duedate_students as $key => $close_fees_duedate_students_val) {

                                                      $student_id = base64_encode($close_fees_duedate_students_val->stid);
                                                      ?>                                           
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('admin/student-details/'.$student_id)}}">{{$close_fees_duedate_students_val->first_name}}</a></td>
                                                         <td>{{$close_fees_duedate_students_val->staff_name}}</td>
                                                         <td>{{$close_fees_duedate_students_val->email}}</td>
                                                         <td>{{$close_fees_duedate_students_val->phone}}</td>
                                                         <td><?php echo date('d-m-Y',strtotime($close_fees_duedate_students_val->fee_due_date)); ?></td>
                                                         <td>
                                                            <?php

                                                            if(isset($close_fees_duedate_students_val->fees_due_snooze_date) && $close_fees_duedate_students_val->fees_due_snooze_date != '')
                                                            {
                                                               $fee_due_date = strtotime($close_fees_duedate_students_val->fees_due_snooze_date);
                                                               echo $close_fees_duedate_students_val->fees_due_snooze_date;
                                                            }
                                                            else
                                                            {   
                                                               $fee_due_date = strtotime($close_fees_duedate_students_val->fee_due_date);
                                                               echo $close_fees_duedate_students_val->fee_due_date;
                                                            }
                                                            ?>
                                                         </td>   
                                                         <td style="white-space:nowrap;">
                                                            <button type="button" class="btn btn-primary visa_status" data-toggle="modal" data-target="#close_visa" data-userid="{{$close_fees_duedate_students_val->stid}}"  data-username="{{$close_fees_duedate_students_val->first_name}}" data-cfd_id="{{$close_fees_duedate_students_val->cfd_id}}">View</button></td>
                                                         </tr>
                                                         <?php $count++; } } ?>
                                                      </tbody>
                                    </table>
      ...
      <div class="modal-content">
        ...
        @csrf
            <div class="modal-body phone_number">
                ...
                <input type="hidden" name="student_id" class="student_id"> 
                <input type="hidden" name="subject" value="Fees Due Followup">              
            </div>
...
<script type="text/javascript">
  ...
  /*  $(document).on('click','.save_visa_exp_open', function(){            
    ...
    $(document).on('click','.save_visa_exp_open',function(){
     ...
     if(type == 'feesdue-open-tab')
     {
        $('.fees_open').addClass('active');
        $('.fees_snooze').removeClass('active');
        $('.fees_close').removeClass('active');        
        $('.feesdue_open').addClass('active show');
        $('.feesdue_snooze').removeClass('active show');
        $('.feesdue_close').removeClass('active show');        
     }  

     if(type == 'feesdue-snooze-tab')
     {
        $('.fees_open').removeClass('active');
        $('.fees_snooze').addClass('active');
        $('.fees_close').removeClass('active');
        $('.feesdue_open').removeClass('active show');
        $('.feesdue_snooze').addClass('active show');
        $('.feesdue_close').removeClass('active show');
     }  
     if(type == 'feesdue-close-tab')
     {
        $('.fees_open').removeClass('active');
        $('.fees_snooze').removeClass('active');
        $('.fees_close').addClass('active');
        $('.feesdue_open').removeClass('active show');
        $('.feesdue_snooze').removeClass('active show');
        $('.feesdue_close').addClass('active show');
     }
