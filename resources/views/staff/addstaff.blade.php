                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-6 chckstrip">
                                                    ...
                                                    <div class="student_mgmt_rights d-none">
                                                        ...
                                                        <input type="checkbox" value="1" {{ old('prospects') == '1' ? 'checked' : ''}} name="prospects" class="chckright"/>
                                                        <b>Prospects</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('clients') == '1' ? 'checked' : ''}} name="clients" class="chckright"/>
                                                        <b>Clients</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('whatsapp') == '1' ? 'checked' : ''}} name="whatsapp" class="chckright"/>
                                                        <b>Whatsapp</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('message') == '1' ? 'checked' : ''}} name="message" class="chckright"/>
                                                        <b>Message</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('email') == '1' ? 'checked' : ''}} name="email" class="chckright"/>
                                                        <b>Email</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('migration') == '1' ? 'checked' : ''}} name="migration" class="chckright"/>
                                                        <b>Migration</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('extra') == '1' ? 'checked' : ''}} name="extra" class="chckright"/>
                                                        <b>Extra</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('mark_unread') == '1' ? 'checked' : ''}} name="mark_unread" class="chckright"/>
                                                        <b>Mark Unread</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('client_notes') == '1' ? 'checked' : ''}} name="client_notes" class="chckright"/>
                                                        <b>Client Notes</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('read_client_notes') == '1' ? 'checked' : ''}} name="read_client_notes" class="chckright"/>
                                                        <b>Read Client Notes</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('checklist') == '1' ? 'checked' : ''}} name="checklist" class="chckright"/>
                                                        <b>Checklist</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('convert_to_client') == '1' ? 'checked' : ''}} name="convert_to_client" class="chckright"/>
                                                        <b>Convert to Client</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('delete') == '1' ? 'checked' : ''}} name="delete" class="chckright"/>
                                                        <b>Delete</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('admission_fees') == '1' ? 'checked' : ''}} name="admission_fees" class="chckright"/>
                                                        <b>Admission Fees</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('material_fees') == '1' ? 'checked' : ''}} name="material_fees" class="chckright"/>
                                                        <b>Material Fees</b>
                                                        <br>

                                                        <input type="checkbox" value="1" {{ old('fees_details') == '1' ? 'checked' : ''}} name="fees_details" class="chckright"/>
                                                        <b>Fees Details</b>
                                                        <br>
