...
<div class="content-wrap">
    <div class="main">
            ...
            <div class="alert alert-warning" id="myDIV" role="alert">
                <strong>{{session()->get('warning')}}</strong> 
                <i class="fa fa-close closeicon" onclick="hide()" aria-hidden="true"></i>
            </div>
            @endif

            <a href="{{url('/admin/other_services/add_service')}}" class="btn btn-outline-primary addnewstaffbtn rightbtns">+ Add New Service</a>
        </div>
    </div>
