                                            ...
                                            <td>  
                                                <div class="dropdown dropbtn">
                                                    ...
                                                    <div class="dropdown-menu dropmenu" aria-labelledby="dropdownMenuButton">
                                                      ...
                                                      <a class="dropdown-item" href="{{url('staff/staff-edit/'.base64_encode($get_staff->id))}}">Edit</a>
                                                      <a class="dropdown-item" href="{{url('staff/staff-delete/'.base64_encode($get_staff->id))}}" onclick="return confirm('Are you sure you want to delete this staff?');">Delete</a>
                                                    </div>
                                                  </div>

                                                {{-- <a href="{{url('staff/staff-edit/'.base64_encode($get_staff->id))}}"><i class="fa fa-edit" style='color: rgb(29, 18, 235)'></i></a> 

                                                <a href="{{url('staff/staff-delete/'.base64_encode($get_staff->id))}}" onclick="return confirm('Are you sure you want to delete this staff?');"><i class="fa-solid fa-trash-can" style='color: red'></i></a> --}}
