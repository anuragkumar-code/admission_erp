            ...
            <div class="container-fluid">
                ...
                <section id="main-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <form action="{{ route('/admin/miscellaneous_income/edit_miscellaneous_income') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-row">
                                      ...
                                      <?php /*  <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="file" class="form-control" placeholder="Enter Invoice" name="invoice">
                                            <?php if($get_miscellaneous_income->invoice != '') { ?>
                                            <a href="{{url('/miscellaneous/'.$get_miscellaneous_income->invoice)}}"><i class="fa fa-image"></i></a>
                                        <?php } ?>
