            ...
            <div class="container-fluid">
                ...
                <section id="main-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <form action="{{ route('staff_add_colleges') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="rto_number" value="{{old('rto_number')}}" onkeypress="return isNumberKey(event)" placeholder="Enter RTO Number" name="rto_number">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="cricos_number" value="{{old('cricos_number')}}" onkeypress="return isNumberKey(event)" placeholder="Enter Cricos Number" name="cricos_number">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" class="form-control" id="admission_email" value="{{old('admission_email')}}" placeholder="Enter Admission Email Address" name="admission_email">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" class="form-control" id="peo_email" value="{{old('peo_email')}}" placeholder="Enter PEO Email Address" name="peo_email">
