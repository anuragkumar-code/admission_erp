                ...
                <div class="headertopcontent">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link passport_open active" id="passportexpire-open-tab" data-toggle="pill" data-target="#passportexpire-open" type="button" role="tab" aria-controls="passportexpire-open-tab" aria-selected="true">Open</button>
                        </li>
                         <li class="nav-item" role="presentation">
                            <button class="nav-link passport_snooze" id="passportexpire-snooze-tab" data-toggle="pill" data-target="#passportexpire-snooze" type="button" role="tab" aria-controls="passportexpire-snooze" aria-selected="false">Snooze</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link passport_close" id="passportexpire-close-tab" data-toggle="pill" data-target="#passportexpire-close" type="button" role="tab" aria-controls="passportexpire-close" aria-selected="false">Close</button>
                        </li>
                            ...
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive studenttabless">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                       <div class="tab-pane fade show active" id="passportexpire-open" role="tabpanel" aria-labelledby="passportexpire-open-tab">
                                          <table class="table table-striped table-bordered" id="open_passport_expire">
                                             ...
                                             <tbody>
                                               ...
                                               //echo "<pre>"; print_r($passport_expiry_students); exit;
                                                if($passport_expiry_students){ 
                                                   $count = 1;
                                                   foreach ($passport_expiry_students as $key => $passport_expiry_students_val) {

                                                       $student_id = base64_encode($passport_expiry_students_val->stid);
                                                      ?>                                           
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('admin/student-details/'.$student_id)}}">{{$passport_expiry_students_val->first_name}}</a></td>
                                                         <td>{{$passport_expiry_students_val->staff_name}}</td>
                                                         <td>{{$passport_expiry_students_val->email}}</td>
                                                         <td>{{$passport_expiry_students_val->phone}}</td>
                                                         <td><?php echo date('d-m-Y',strtotime($passport_expiry_students_val->passport_expiry_date)); ?></td>
                                                         <td>
                                                            <?php
                                                               if(isset($passport_expiry_students_val->passport_snooze_date) && $passport_expiry_students_val->passport_snooze_date != '')
                                                             {
                                                               $passport_expiry_date = strtotime($passport_expiry_students_val->passport_snooze_date);
                                                               echo date('d-m-Y',strtotime($passport_expiry_students_val->passport_snooze_date));
                                                            }
                                                            else
                                                            {   
                                                               $passport_expiry_date = strtotime($passport_expiry_students_val->passport_expiry_date);
                                                               echo date('d-m-Y',strtotime($passport_expiry_students_val->passport_expiry_date));
                                                            }
                                                            ?>
                                                         </td>
                                                         <td>
                                                            <?php
                                                            if($passport_expiry_students_val->passport_snooze_date != '')
                                                            {
                                                               $passport_expiry_date = strtotime($passport_expiry_students_val->passport_snooze_date);

                                                               if($curr_date > $passport_expiry_date)
                                                               {
                                                                  ?>
                                                         ...
                                                         <td style="width: 170px;float: right;">
                                                            ...
                                                            <a href="javascript:void(0);" data-id="{{$passport_expiry_students_val->id}}" data-name="{{$passport_expiry_students_val->first_name}}" data-phone="{{$passport_expiry_students_val->phone}}"  data-dialcode="{{$passport_expiry_students_val->phone_dialcode}}"  data-flag="{{$passport_expiry_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_sms"><i style='font-size:22px !important' class="fa fa-comment-o"></i></a>    


                                                        <a href="javascript:void(0);" data-id="{{$passport_expiry_students_val->id}}" data-name="{{$passport_expiry_students_val->first_name}}" data-phone="{{$passport_expiry_students_val->phone}}"  data-dialcode="{{$passport_expiry_students_val->phone_dialcode}}"  data-flag="{{$passport_expiry_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_whatsapp"><i style='font-size:22px !important'  class="fa fa-whatsapp" aria-hidden="true"></i></a> 


                                                        <a href="javascript:void(0);" data-id="{{$passport_expiry_students_val->id}}" data-name="{{$passport_expiry_students_val->first_name}}" data-phone="{{$passport_expiry_students_val->phone}}" data-email="{{$passport_expiry_students_val->email}}"  data-dialcode="{{$passport_expiry_students_val->phone_dialcode}}"  data-flag="{{$passport_expiry_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_mail"><i style='font-size:22px !important'  class="fa fa-envelope-o" aria-hidden="true"></i></a> 

                                                            <button type="button" class="btn btn-primary visa_status" data-toggle="modal" data-target="#open_visa" data-userid="{{$passport_expiry_students_val->stid}}" data-username="{{$passport_expiry_students_val->first_name}}">View</button></td>
                                                         </tr>
                                                         <?php $count++; }  }?>
                                                      </tbody>
                                                   </table>                                           
...
<div class="tab-pane fade" id="passportexpire-snooze" role="tabpanel" aria-labelledby="passportexpire-snooze">  

        <table class="table table-striped table-bordered" id="snooze_passport_expire">
                                        <thead class="thead-dark">
                                            <tr>
                                                   <th scope="col">S. No.</th>
                                                   <th scope="col">Name</th>
                                        ...
                                        <tbody>
                                                <?php
                                                $curr_date =  strtotime(date('d-m-Y'));
                                                if($snooze_passport_expiry_students){ 
                                                   $count = 1;
                                                   foreach ($snooze_passport_expiry_students as $key => $snooze_passport_expiry_students_val) {

                                                       $student_id = base64_encode($snooze_passport_expiry_students_val->stid);
                                                      ?>                                           
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('admin/student-details/'.$student_id)}}">{{$snooze_passport_expiry_students_val->first_name}}</a></td>
                                                         <td>{{$snooze_passport_expiry_students_val->staff_name}}</td>
                                                         <td>{{$snooze_passport_expiry_students_val->email}}</td>
                                                         <td>{{$snooze_passport_expiry_students_val->phone}}</td>
                                                        <td><?php echo date('d-m-Y',strtotime($snooze_passport_expiry_students_val->passport_expiry_date)); ?></td>
                                                         <td>
                                                            <?php
                                                            if(isset($snooze_passport_expiry_students_val->passport_snooze_date) && $snooze_passport_expiry_students_val->passport_snooze_date != '')
                                                            {
                                                               $passport_expiry_date = strtotime($snooze_passport_expiry_students_val->passport_snooze_date);
                                                               echo date('d-m-Y',strtotime($snooze_passport_expiry_students_val->passport_snooze_date));
                                                            }
                                                            else
                                                            {   
                                                               $passport_expiry_date = strtotime($snooze_passport_expiry_students_val->passport_expiry_date);
                                                               echo date('d-m-Y',strtotime($snooze_passport_expiry_students_val->passport_expiry_date));
                                                            }
                                                            ?>
                                                         </td>
                                                         ...
                                                         <td style="width: 170px;float: right;">
                                                            ...
                                                            <a href="javascript:void(0);" data-id="{{$snooze_passport_expiry_students_val->id}}" data-name="{{$snooze_passport_expiry_students_val->first_name}}" data-phone="{{$snooze_passport_expiry_students_val->phone}}"  data-dialcode="{{$snooze_passport_expiry_students_val->phone_dialcode}}"  data-flag="{{$snooze_passport_expiry_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_sms"><i style='font-size:22px !important' class="fa fa-comment-o"></i></a>    


                                                        <a href="javascript:void(0);" data-id="{{$snooze_passport_expiry_students_val->id}}" data-name="{{$snooze_passport_expiry_students_val->first_name}}" data-phone="{{$snooze_passport_expiry_students_val->phone}}"  data-dialcode="{{$snooze_passport_expiry_students_val->phone_dialcode}}"  data-flag="{{$snooze_passport_expiry_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_whatsapp"><i style='font-size:22px !important'  class="fa fa-whatsapp" aria-hidden="true"></i></a> 


                                                        <a href="javascript:void(0);" data-id="{{$snooze_passport_expiry_students_val->id}}" data-name="{{$snooze_passport_expiry_students_val->first_name}}" data-phone="{{$snooze_passport_expiry_students_val->phone}}" data-email="{{$snooze_passport_expiry_students_val->email}}"  data-dialcode="{{$snooze_passport_expiry_students_val->phone_dialcode}}"  data-flag="{{$snooze_passport_expiry_students_val->phone_flag}}"  data-toggle="modal" class="message topicon01 msgicons" data-target="#send_mail"><i style='font-size:22px !important'  class="fa fa-envelope-o" aria-hidden="true"></i></a> 

                                                            <button type="button" class="btn btn-primary visa_status" data-toggle="modal" data-target="#open_visa" data-userid="{{$snooze_passport_expiry_students_val->stid}}"  data-username="{{$snooze_passport_expiry_students_val->first_name}}">View</button></td>
                                                         </tr>
                                                         <?php $count++; }  }?>
                                                      </tbody>
                                    </table> 
        ...
        <div class="tab-pane fade" id="passportexpire-close" role="tabpanel" aria-labelledby="passportexpire-close"> 

        <table class="table table-striped table-bordered" id="close_passport_expire">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th scope="col">S. No.</th>
                                                   <th scope="col">Name</th>
                                        ...
                                        <tbody>
                                                <?php
                                                $curr_date =  strtotime(date('d-m-Y'));
                                                if($close_passport_expiry_students){ 
                                                   $count = 1;
                                                   foreach ($close_passport_expiry_students as $key => $close_passport_expiry_students_val) {

                                                      $student_id = base64_encode($close_passport_expiry_students_val->stid);
                                                      ?>                                           
                                                      <tr>
                                                         <td>{{$count}}</td>
                                                         <td><a href="{{url('admin/student-details/'.$student_id)}}">{{$close_passport_expiry_students_val->first_name}}</a></td>
                                                         <td>{{$close_passport_expiry_students_val->staff_name}}</td>
                                                         <td>{{$close_passport_expiry_students_val->email}}</td>
                                                         <td>{{$close_passport_expiry_students_val->phone}}</td>
                                                         <td><?php echo date('d-m-Y',strtotime($close_passport_expiry_students_val->passport_expiry_date)); ?></td>
                                                         <td>
                                                            <?php
                                                            if(isset($close_passport_expiry_students_val->passport_snooze_date) && $close_passport_expiry_students_val->passport_snooze_date != '')
                                                            {
                                                               $passport_expiry_date = strtotime($close_passport_expiry_students_val->passport_snooze_date);
                                                               echo date('d-m-Y',strtotime($close_passport_expiry_students_val->passport_snooze_date));
                                                            }
                                                            else
                                                            {   
                                                               $passport_expiry_date = strtotime($close_passport_expiry_students_val->passport_expiry_date);
                                                               echo date('d-m-Y',strtotime($close_passport_expiry_students_val->passport_expiry_date));
                                                            }
                                                            ?>
                                                         </td>   
                                                         <td style="white-space:nowrap;">
                                                            <button type="button" class="btn btn-primary visa_status" data-toggle="modal" data-target="#close_visa" data-userid="{{$close_passport_expiry_students_val->stid}}"  data-username="{{$close_passport_expiry_students_val->first_name}}">View</button></td>
                                                         </tr>
                                                         <?php $count++; } } ?>
                                                      </tbody>
                                    </table>
      ...
      <div class="modal-content">
        ...
        @csrf
            <div class="modal-body phone_number">
                ...
                <input type="hidden" name="student_id" class="student_id">
                <input type="hidden" name="subject" value="Passport Followup">               
            </div>
...
<script type="text/javascript">
    ...
    $('#open_passport_expire').DataTable();
    $('#snooze_passport_expire').DataTable();
    $('#close_passport_expire').DataTable();
    ...
    var type = window.location.hash.substr(1);
     if(type == 'passportexpire-open-tab')
     {
        $('.passport_open').addClass('active');
        $('.passport_snooze').removeClass('active');
        $('.passport_close').removeClass('active');        
        $('#passportexpire-open').addClass('active show');
        $('#passportexpire-snooze').removeClass('active show');
        $('#passportexpire-close').removeClass('active show');        
     }  

     if(type == 'passportexpire-snooze-tab')
     {
        $('.passport_open').removeClass('active');
        $('.passport_snooze').addClass('active');
        $('.passport_close').removeClass('active');
        $('#passportexpire-open').removeClass('active show');
        $('#passportexpire-snooze').addClass('active show');
        $('#passportexpire-close').removeClass('active show');
     }  
     if(type == 'passportexpire-close-tab')
     {
        $('.passport_open').removeClass('active');
        $('.passport_snooze').removeClass('active');
        $('.passport_close').addClass('active');
        $('#passportexpire-open').removeClass('active show');
        $('#passportexpire-snooze').removeClass('active show');
        $('#passportexpire-close').addClass('active show');
     }   
