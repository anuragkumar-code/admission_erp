        ...
        <div class="container-fluid">
            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <form action="{{url('/staff/college-updated/'.$edit_colleges->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" value="{{$edit_colleges->rto_number}}" onkeypress="return isNumberKey(event)" id="rto_number"name="rto_number" placeholder="Enter RTO Number">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text"  value="{{$edit_colleges->cricos_number}}" onkeypress="return isNumberKey(event)" class="form-control" id="cricos_number"  name="cricos_number"  placeholder="Enter Cricos Number">
