            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="addnewbtntop">
                        ...
                        <a href="{{ url('admin/add_course_campus/'.$college_id) }}" class="btn btn-outline-primary addnewstaffbtn rightbtns"> + Add New Course</a>
                        <?php } ?>
                    </div>
                    ...
                    <div class="table-responsive studenttabless">                                                      
                        ...
                        <table class="table table-striped table-bordered" id="bootstrap-data-table-export">
                            ...
                            <tr>
                                ...
                                <th scope="col" width="80%">Course Name</th>
                                <th scope="col" width="10%">Course Duration</th>
                                        ...
                                        <td>  
                                            <div class="dropdown dropbtn">
                                                ...
                                                <div class="dropdown-menu dropmenu" aria-labelledby="dropdownMenuButton">
                                                  ...
                                                  <a class="dropdown-item" href="{{url('admin/edit_course_campus/'.base64_encode($get_course->id))}}">Edit Course</a>

                                                  <!-- <a class="dropdown-item" href="{{url('admin/course-edit/'.base64_encode($get_course->id))}}">Edit Course</a> -->

                                                  <a class="dropdown-item" href="{{url('admin/course-deleted/'.base64_encode($get_course->id))}}" onclick="return confirm('Are you sure you want to delete this course?');">Delete</a>
                                                </div>
                                              </div>
                                        </td>    
                                        <?php } ?>                                 
