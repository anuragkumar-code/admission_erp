        ...
        <div class="container-fluid">
            <div class="row">
                <div class="headertopcontent">
                    ...
                    <a href="{{url('staff/add_task')}}" class="btn btn-outline-primary addnewstaffbtn rightbtns">+ Add New Task</a>
                </div>
                                            ...
                                            <td> 
                                                ...
                                                <div class="dropdown dropbtn">
                                                    ...
                                                    <div class="dropdown-menu dropmenu" aria-labelledby="dropdownMenuButton">
                                                      ...
                                                      <a class="dropdown-item" href="{{url('/staff/edit_task/'.base64_encode($get_task_data->id))}}">Edit Task</a>
                                                   ...
                                                   <?php } ?>
                                                      <a class="dropdown-item" href="{{url('/staff/task_delete/'.base64_encode($get_task_data->id))}}" onclick="return confirm('Are you sure you want to delete this Task?');">Delete</a>
                                                    </div>
                                                </div>
                                            ...
                                            <td>  
                                                <div class="dropdown dropbtn">
                                                    ...
                                                    <div class="dropdown-menu dropmenu" aria-labelledby="dropdownMenuButton">
                                                      ...
                                                      <a class="dropdown-item" href="{{url('/staff/edit_task/'.base64_encode($get_snoozed_task_data->id))}}">Edit Task</a>
                                                      <a class="dropdown-item" href="{{url('/staff/task_delete/'.base64_encode($get_snoozed_task_data->id))}}" onclick="return confirm('Are you sure you want to delete this Task?');">Delete</a>
                                                    </div>
                                                </div>
                                            </td>                                     
                                        </tr>
                                            ...
                                            <td>
                                                <div class="dropdown dropbtn">
                                                    ...
                                                    <div class="dropdown-menu dropmenu" aria-labelledby="dropdownMenuButton">
                                                      ...
                                                      <a class="dropdown-item" href="{{url('/staff/edit_task/'.base64_encode($get_closed_task_data->id))}}">Edit Task</a>
                                                      <a class="dropdown-item" href="{{url('/staff/task_delete/'.base64_encode($get_closed_task_data->id))}}" onclick="return confirm('Are you sure you want to delete this Task?');">Delete</a>
                                                    </div>
                                                </div>                                               
                                            </td>
                                        </tr>
...
$(document).on('click','.show_taskdetail', function(){
    ...
    $(document).on('click','.opnetaskmodal', function(){
        ...
        $.ajax({
                type: "POST",
                url: "{{route('/staff/ajax_task_comment_data')}}",
    ...
    $(document).on('click','.read', function(){
        ...
        $.ajax({
                type: "POST",
                url: "{{route('/staff/ajax_task_read_unread')}}",
