...
<div class="content-wrap">
    <div class="main">
            ...
            <a href="{{url('/staff/miscellaneous_income/add_miscellaneous_income')}}" class="btn btn-outline-primary addnewstaffbtn rightbtns">+ Add New Miscellaneous Income</a>
        </div>
    </div>
                                                ...
                                                <td>
                                                    <div class="dropdown dropbtn">
                                                        ...
                                                        <div class="dropdown-menu dropmenu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <a class="dropdown-item" href="{{url('/staff/miscellaneous_income/edit_miscellaneous_income/'.$miscellaneous_list_val->id) }}">Edit</a>
                                                            <a class="dropdown-item" href="{{url('/staff/miscellaneous_income/delete_miscellaneous_income/'.$miscellaneous_list_val->id)}}" onclick="return confirm('Are you sure you want to delete this Record?');">Delete</a>
                                                        </div>
                                                    </div>                                               
                                                </td>
                                            </tr>
