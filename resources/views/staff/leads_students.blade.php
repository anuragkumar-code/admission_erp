                                            ...
                                            //echo "<pre>"; print_r($get_lead_students); exit;
                                             ...
                                             if($get_lead_students){ 
                                                ...
                                                <tr class="migration_row<?php echo $get_lead_student->id; ?> student_row{{$get_lead_student->id}} <?php echo $unread_clientnotes; ?>">
                                                    ...
                                                    <td><a style="color: blue" href="{{url('staff/student-details/'.base64_encode($get_lead_student->id))}}">{{$get_lead_student->first_name}} {{$get_lead_student->middle_name}} {{$get_lead_student->last_name}}</a>
                                                        <i class='fa fa-check-circle' style='color:#39f358'>
                                                    </td>
                                                    <td>{{$get_lead_student->staff_name}}  @if(Auth::user()->type==2 )  <?php if(isset($get_lead_student->office_name)) {?>({{$get_lead_student->office_name}}) <?php }?> @endif</td>
                                                    ...
                                                    <div class="dropdown dropbtn">
                                                        ...
                                                        <?php } ?>
                                                            ...
                                                            if($student_delete_management == 1)
                                                            {
                                                             ?>
