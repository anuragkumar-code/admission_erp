                                ...
                                ?> </td>
                                    ...
                                    <td><?php /*if($view_fee_detail->received_amount == null && $count==0 ){*/
                                       ...
                                       ?>
                                         ...
                                         <button class="btn btn-default send_reciept" data-student_id="{{$view_fee_detail->student_id}}" data-college_id="{{$view_fee_detail->college_id}}" data-course_id="{{$view_fee_detail->course_id}}" data-fee_id="{{$view_fee_detail->id}}">Send Reciept</button>
                                       <?php     
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                        <label for="amount"><strong>Amount : <span style='color: red'>*</span></strong></label><br>
                        <input type="number" class="form-control" id="amount" name="amount" min="1" max="<?php echo $view_curr_course->fees-$view_curr_course->rec_admission_fees; ?>"><br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                        <label for="amount"><strong>Amount : <span style='color: red'>*</span></strong></label><br>
                        <input type="number" class="form-control" id="amount" name="amount" min="1" max="<?php echo $view_curr_course->material_fees-$view_curr_course->rec_material_fees; ?>"><br>
