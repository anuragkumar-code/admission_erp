            ...
            <div class="container-fluid">
                ...
                <section id="main-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <form action="{{ route('/admin/miscellaneous_income/add_miscellaneous_income') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="other_services">
                                                ...
                                                <?php if($other_services){
                                                    ...
                                                    {
                                                    ?>
                                                    <option value="{{$other_services_value->id}}">{{$other_services_value->service_name}}</option>
                                                    <?php
                                                    }
                                                } ?>
                                            </select>
                                         ...
                                         <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="income" value="{{old('income')}}" placeholder="Enter Income" name="income">
                                          ...
                                          <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="total_recieve"  placeholder="Enter Total Recieve" name="total_recieve">
                                            <p class="text-danger">@error('total_recieve'){{ $message }} @enderror</p>
                                        </div>


                                        <div class="form-group col-md-4">
                                            <label for="invoice"><strong>Invoice </label>
                                            <input type="file" class="form-control" placeholder="Enter Total Recieve" name="invoice">
                                            <p class="text-danger">@error('invoice'){{ $message }} @enderror</p>
                                        </div>
