                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <form action="{{ route('update_other_details') }}" method="post" enctype="multipart/form-data" id="update_student_other_detail">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4 ">
                                            ...
                                            <input type="date"  class="form-control" name="intake_date[<?php echo $counter; ?>]" id="intake_date<?php echo $counter; ?>" placeholder="Enter End Date" @if($fee_details_val->intake_date!='') disabled="true" value="{{$fee_details_val->intake_date}}" @else value="{{old('intake_date')}}" @endif>
                                ...
                                <input type="hidden" value="<?php echo $fee_details_val->id; ?>" name="course_fees_id[<?php echo $counter; ?>]">
                                        ...
                                        <div class="form-group col-md-4 ">
                                            <label for="intake_date"><strong>Intake Date <span style='color: red'>*</span></strong></label>
                                            <input type="date"  class="form-control" id="intake_date" placeholder="Enter End Date" name="intake_date[1]">
                                            <p class="text-danger">@error('intake_date'){{ $message }}@enderror</p>
                                        </div>
